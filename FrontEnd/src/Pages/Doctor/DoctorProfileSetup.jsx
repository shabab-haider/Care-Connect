...
const DoctorProfileSetup = () => {
    ...
    const calculateSectionCompletion = (section) => {
        ...
        if (section === "basic") {
            ...
            fields = ["specialty", "licenseNumber", "yearsOfExperience"]
        } else if (section === "clinic") {
            fields = ["clinicName", "clinicAddress", "consultationHours"]
        }

        fields.forEach((field) => {
            if (completedFields[field]) {
                completedCount++
            }
        })
    ...
    useEffect(() => {
        ...
        // Calculate weighted progress (each section is 33.33%)
        const basicProgress = calculateSectionCompletion("basic") * 0.33
        const professionalProgress = calculateSectionCompletion("professional") * 0.33
        const clinicProgress = calculateSectionCompletion("clinic") * 0.33

        newProgress = basicProgress + professionalProgress + clinicProgress
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        console.log({
            basicInfo: { fullName, dateOfBirth, gender, phoneNumber },
            professionalDetails: { specialty, licenseNumber, yearsOfExperience },
            clinicInfo: { clinicName, clinicAddress, consultationHours: `${consultationStartTime} - ${consultationEndTime}` },
        })
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <form onSubmit={handleSubmit}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          updateFieldStatus("fullName", e.target.value);
                        }}
                        required
                      />
                    </div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            updateFieldStatus("dateOfBirth", e.target.value);
                          }}
                          required
                        />
                      </div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            updateFieldStatus("gender", e.target.value);
                          }}
                          required
                        >
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            updateFieldStatus("phoneNumber", e.target.value);
                          }}
                          required
                        />
                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            updateFieldStatus("specialty", e.target.value);
                          }}
                          required
                        >
                          <option value="" disabled>
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            updateFieldStatus("licenseNumber", e.target.value);
                          }}
                          required
                        />
                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                ...
                <div
                  className={activeSection === "clinic" ? "block" : "hidden"}
                >
                  <h2 className="text-xl font-semibold mb-6">
                    Clinic Information
                  </h2>
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            updateFieldStatus("clinicName", e.target.value);
                          }}
                          required
                        />
                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            updateFieldStatus("clinicAddress", e.target.value);
                          }}
                          required
                        />
                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        ...
                        <div className="relative">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              updateFieldStatus(
                                "consultationHours",
                                e.target.value && consultationEndTime
                              );
                            }}
                            required
                          />
