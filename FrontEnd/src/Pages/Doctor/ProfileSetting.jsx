...
const DoctorProfile = () => {
    ...
    const [doctorData, setDoctorData] = useState({
        fullName: "Syed Shabab",
        email: "syyed.shhabab@careconnect.com",
        ...
        appointmentHistory: [
            { date: "Jan 15, 2024", time: "10:00 AM", patient: "John Doe", status: "Completed" },
            { date: "Jan 12, 2024", time: "2:30 PM", patient: "Jane Smith", status: "Completed" },
            { date: "Jan 10, 2024", time: "11:15 AM", patient: "Mike Johnson", status: "Cancelled" },
        ],
        stats: {
            patients: "1.2k+",
            years: "8+",
    ...
    const handleCancel = () => {
        // Reset any changes and exit editing mode
        setIsEditing({
            personal: false,
            professional: false,
        })
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto px-4 py-6">
                    ...
                    <div className="w-full md:w-1/4">
                        <div className="bg-white rounded-lg shadow-sm p-6 mb-6 flex flex-col items-center">
                            <div className="relative mb-4">
                                <img src="/placeholder.svg" alt="Dr. Syed Shabab" className="w-32 h-32 rounded-full object-cover" />
                                <label htmlFor="profilePictureUpload" className="absolute bottom-0 right-0 bg-white rounded-full p-1 shadow-md cursor-pointer">
                                    <svg
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (file) {
                                            ...
                                            reader.onload = () => {
                                                ...
                                                document.querySelector("img[alt='Dr. Syed Shabab']").src = reader.result;
                                            };
                            ...
                            <h2 className="text-xl font-bold text-gray-800 mb-1">Dr. Syed Shabab</h2>
                            ...
                            <div className="w-full space-y-3 mb-6">
                                <div className="flex items-center text-gray-600">
                                    ...
                                    <span>sarah.wilson@careconnect.com</span>
                                </div>
                                <div className="flex items-center text-gray-600">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="w-full md:w-3/4">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button className="text-blue-500 hover:text-blue-700" onClick={() => toggleEditing("personal")}>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5"
                                        fill="none"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className={`w-full px-3 py-2 border ${isEditing.personal ? "border-blue-300" : "border-gray-200 bg-gray-50"} rounded-md ${isEditing.personal ? "focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" : ""}`}
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button className="text-blue-500 hover:text-blue-700" onClick={() => toggleEditing("professional")}>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5"
                                        fill="none"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className={`w-full px-3 py-2 border ${isEditing.professional ? "border-blue-300" : "border-gray-200 bg-gray-50"} rounded-md ${isEditing.professional ? "focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" : ""}`}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">CheckUp Fees</label>
                                    <input
                                        type="text"
                                        className={`w-full px-3 py-2 border ${isEditing.professional ? "border-blue-300" : "border-gray-200 bg-gray-50"} rounded-md ${isEditing.professional ? "focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" : ""}`}
                                        value={doctorData.checkupFees}
                                        onChange={(e) => handleInputChange("professional", "checkupFees", e.target.value)}
                                        readOnly={!isEditing.professional}
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {doctorData.availableTimeSlots.map((slot, index) => (
                                        <div key={index} className="flex items-center">
                                            ...
                                            <div className="w-2/3 flex items-center">
                                                <span
                                                    className={`px-3 py-2 border ${isEditing.professional ? "border-blue-300" : "border-gray-200 bg-gray-50"} rounded-md flex-grow`}
                                                >
                                                    {slot.time}
                                                </span>
                                        ...
                                        {doctorData.appointmentHistory.map((appointment, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${appointment.status === "Completed"
                ...
                {/* Action Buttons */}
                {(isEditing.personal || isEditing.professional) && (
