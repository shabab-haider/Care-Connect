        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border">
          ...
          <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${
                userType === "patient" ? "bg-white text-blue-600 shadow-sm" : "text-gray-600 hover:text-gray-900"
              }`}
            >
              Patient
            </button>
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${
                userType === "doctor" ? "bg-white text-blue-600 shadow-sm" : "text-gray-600 hover:text-gray-900"
              }`}
            >
              Doctor
            </button>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to={`/${userType}-signup`} className="text-blue-600 hover:text-blue-700 font-medium">
                Sign up here
              </Link>
            </p>
          </div>
