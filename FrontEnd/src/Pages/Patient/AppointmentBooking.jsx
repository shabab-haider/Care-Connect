...
const AppointmentBooking = () => {
    ...
    const handleConfirmAppointment = () => {
        ...
        console.log("Appointment confirmed:", { selectedDoctor, selectedDate, selectedTime })
        setCurrentStep(3)
    }
            ...
            <header className="bg-white border-b border-gray-200">
                <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex justify-evenly items-center space-x-6">
                        ...
                        <Link to="/appointments" className="flex items-center text-blue-500 font-medium">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-5 w-5 mr-1"
                                fill="none"
                    ...
                    <div className="flex  items-center">
                        <div className="flex items-center bg-gray-100 rounded-full p-1 px-3">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span className="ml-2 py-2 text-gray-700 whitespace-nowrap">John Doe</span>
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div className="container mx-auto px-4 py-6 border-b border-gray-200">
                <div className="flex items-center justify-center max-w-md mx-auto">
                    ...
                    <div className="flex flex-col items-center flex-1">
                        <div
                            className={`w-8 h-8 flex items-center justify-center rounded-full ${currentStep === 1
                        ...
                        <span
                            className={`mt-2 text-xs ${currentStep === 1 ? "text-blue-500" : currentStep > 1 ? "text-green-500" : "text-gray-500"
                                }`}
                        >
                            Select Doctor
                        </span>
                    ...
                    <div className="w-full h-1 bg-gray-200 mx-2">
                        <div className={`h-full bg-blue-500 ${currentStep > 1 ? "w-full" : "w-0"}`}></div>
                    </div>
                    ...
                    <div className="flex flex-col items-center flex-1">
                        ...
                        <span
                            className={`mt-2 text-xs ${currentStep === 2 ? "text-blue-500" : currentStep > 2 ? "text-green-500" : "text-gray-500"
                                }`}
                        >
                            Schedule Time
                        </span>
                    ...
                    {/* Line between steps */}
                    <div className="w-full h-1 bg-gray-200 mx-2">
                        <div className={`h-full bg-blue-500 ${currentStep > 2 ? "w-full" : "w-0"}`}></div>
                    </div>
                    ...
                    <div className="flex flex-col items-center flex-1">
                        ...
                        <span
                            className={`mt-2 text-xs ${currentStep === 3 ? "text-blue-500" : currentStep > 3 ? "text-green-500" : "text-gray-500"
                                }`}
                        >
                            Confirm Details
                        </span>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-7 gap-1">
                                    {calendarDays.map((date, index) => (
                                        <button
                                            key={index}
                                            className={`h-8 w-8 mx-auto rounded-full flex items-center justify-center text-sm ${isDateSelected(date) ? "bg-blue-500 text-white" : "hover:bg-gray-100 text-gray-700"
                                                }`}
                            ...
                            {/* Time Slots */}
                            <h3 className="text-base font-medium mb-4">Available Time Slots</h3>
                            <div className="grid grid-cols-4 gap-2 mb-6">
                                {timeSlots.map((time) => (
                                    <button
                                        key={time}
                                        className={`py-2 px-1 rounded text-center text-sm ${isTimeSelected(time)
                                                ? "bg-blue-500 text-white"
                            ...
                            <div className="mt-8 border-t pt-6">
                                <h3 className="text-base font-medium mb-4">Selected Appointment Details</h3>
