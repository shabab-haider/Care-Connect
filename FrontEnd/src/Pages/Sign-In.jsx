            ...
            <div className="w-full lg:w-1/2 flex flex-col p-10 lg:p-20 justify-center h-screen">
                <div className="mb-10">
                    <Link to="/" className="flex items-center">
                        ...
                        />
                        <span className="ml-2 text-xl font-bold text-gray-800">Care Connect</span>
                    </Link>
                </div>
                ...
                <div className="flex mb-6">
                    <button
                        className={`flex-1 py-3 border border-gray-300 rounded-l-md ${loginType === "patient" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-500"
                            }`}
                    ...
                    <button
                        className={`flex-1 py-3 border border-gray-300 rounded-r-md ${loginType === "doctor" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-500"
                            }`}
                ...
                <div className="h-full relative">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="relative w-full h-full">
                            <img src={signIn_image} alt="Healthcare professional" className="w-full h-full object-cover" />
                            ...
                            <div className="absolute bottom-20 left-10 right-10 text-white">
                                ...
                                <p className="text-lg">
                                    Connect with trusted healthcare professionals and manage your appointments with ease.
                                </p>
                            </div>
                        </div>
                    </div>
